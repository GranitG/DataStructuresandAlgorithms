...
public class graph {
    private int[][] matrix;  // The adjacencyk matrix for the graph
    private boolean[] visited; // An array, storing the 'visited' status of each node
     ...
     * yet been visited.
     */
    private graph(int nodes, String name) {
    ...
    private void printMatrix() {
        ...
        System.out.println("\n");
        int node = 1;
        whatever(node, matrix);
        System.out.println();
    }

    static void whatever(int node, int[][] matrix) {
