...
public class searchMethods {
    ...
    public static void aStar(int[][] graph, int startAt, int lookFor, boolean[] visited){
        int[] Hueristics = {10,6,3,1,0};
    ...
    public static void main(String[] args) {
        ...
        int[][] g3 = new int[5][5];
        // an array for tacking whether a node in g2 has been visited
        boolean[] g3Visited = visitedList(7);

        edge(g3, 1, 2, 10); // Node 1 connects to nodes 2 and 4
        edge(g3, 1, 4, 5);
        ...
        edge(g3, 4, 2, 3); // Node 4 connects to 2, 3, 7
        edge(g3, 4, 3, 9);
        edge(g3, 4, 5, 2);

        edge(g3, 5, 1, 7); // Node 5 connects to 1, 3, 6
        edge(g3, 5, 3, 6);

        System.out.println("Graph 3: Non-Adjacent matrix.");
        printMatrix(g3);
